# =============================================================================
# Variables for Connectivity Network Deployment 1
# =============================================================================
...
variable "connectivity_resource_group_name" {
  type        = string
  description = "Name of the resource group for the connectivity VNet."
}
...
variable "connectivity_network_watcher_resource_group" {
  type        = string
  description = "Name of the dedicated resource group for the Network Watcher."
}
...
variable "connectivity_subnets" {
  ...
  description = "Map of subnet names to their configurations for the connectivity VNet."
}
