...
output "nsg_resource_group_name" {
  description = "The name of the resource group containing the connectivity NSGs."
  value       = azurerm_resource_group.this.name
}

output "nsg_resource_group_id" {
  description = "The ID of the resource group containing the connectivity NSGs."
  value       = azurerm_resource_group.this.id
}

output "nsg_ids" {
  description = "Map of subnet name to NSG ID for connectivity hub NSGs."
  value       = { for k, v in azurerm_network_security_group.nsgs : k => v.id }
}

output "nsg_names" {
  description = "Map of subnet name to NSG name for connectivity hub NSGs."
