# =============================================================================
# Variables for Connectivity NSG Deployment 1
# =============================================================================
...
variable "connectivity_nsg_names" {
  type        = map(string)
  description = "Map of subnet name to NSG name for connectivity hub subnets."
}
...
variable "snet_tools_hub_cus_01_subnet_name" {
  type        = string
  description = "Name of the tools subnet in the hub VNet."
}
