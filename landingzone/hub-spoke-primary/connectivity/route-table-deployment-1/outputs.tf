...
output "route_table_resource_group_name" {
  description = "The name of the resource group containing the connectivity hub route table."
  value       = azurerm_resource_group.this.name
}

output "route_table_resource_group_id" {
  description = "The ID of the resource group containing the connectivity hub route table."
