...
# Reference to Connectivity Network Deployment 1 for VNet and Subnet information
...
# Reference to Identity Network Deployment 1 for Private DNS Zones
...
# Reference to Management Tools Deployment 1 for Log Analytics Workspace
