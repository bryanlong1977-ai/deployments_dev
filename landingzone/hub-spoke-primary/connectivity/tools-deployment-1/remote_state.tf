...
# Reference Connectivity Network Deployment 1 outputs
...
# Reference Identity Network Deployment 1 outputs (for Private DNS Zones)
...
# Reference Management Tools Deployment 1 outputs (for Log Analytics Workspace)
