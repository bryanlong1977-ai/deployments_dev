variable "connectivity_subscription_id" {
  type        = string
  description = "The subscription ID for the Connectivity subscription where AMPLS resources are deployed."
}
...
variable "hub_azure_monitor_private_link_scope_name" {
  type        = string
  description = "Name of the Azure Monitor Private Link Scope resource."
}

variable "hub_azure_monitor_private_link_scope_resource_group" {
  type        = string
  description = "Name of the resource group for the Azure Monitor Private Link Scope."
}

variable "snet_pe_hub_cus_01_subnet_name" {
  type        = string
  description = "Name of the private endpoint subnet in the hub VNet, used as a map key for subnet ID lookup."
}
