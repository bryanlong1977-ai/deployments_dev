...
variable "identity_nsg_resource_group" {
  type        = string
  description = "The resource group name for Identity NSGs."
}

variable "identity_nsg_names" {
  type        = map(string)
  description = "Map of subnet name to NSG name for the Identity subscription."
}

variable "identity_vnet_address_space" {
  type        = string
  description = "The address space of the Identity VNet."
}

variable "identity_subnet_cidrs" {
  type        = map(string)
  description = "Map of subnet name to CIDR for the Identity VNet."
}

variable "regional_cidr" {
  type        = string
  description = "The regional CIDR block for the landing zone."
}

variable "snet_pe_idm_cus_01_subnet_name" {
  type        = string
  description = "The name of the private endpoints subnet in the Identity VNet."
}

variable "snet_tools_idm_cus_01_subnet_name" {
  type        = string
  description = "The name of the tools subnet in the Identity VNet."
}

variable "snet_inbound_idm_cus_01_subnet_name" {
  type        = string
  description = "The name of the DNS resolver inbound subnet in the Identity VNet."
}

variable "snet_outbound_idm_cus_01_subnet_name" {
  type        = string
  description = "The name of the DNS resolver outbound subnet in the Identity VNet."
}

variable "snet_dc_idm_cus_01_subnet_name" {
  type        = string
  description = "The name of the domain controllers subnet in the Identity VNet."
}
