...
variable "idm_route_table_name" {
  type        = string
  description = "Name of the identity route table."
}

variable "idm_route_table_resource_group" {
  type        = string
  description = "Resource group name for the identity route table."
}

variable "snet_pe_idm_cus_01_subnet_name" {
  type        = string
  description = "Name of the private endpoints subnet in identity VNet."
}

variable "snet_tools_idm_cus_01_subnet_name" {
  type        = string
  description = "Name of the tools subnet in identity VNet."
}

variable "snet_inbound_idm_cus_01_subnet_name" {
  type        = string
  description = "Name of the DNS resolver inbound subnet in identity VNet."
}

variable "snet_outbound_idm_cus_01_subnet_name" {
  type        = string
  description = "Name of the DNS resolver outbound subnet in identity VNet."
}

variable "snet_dc_idm_cus_01_subnet_name" {
  type        = string
  description = "Name of the domain controllers subnet in identity VNet."
}
