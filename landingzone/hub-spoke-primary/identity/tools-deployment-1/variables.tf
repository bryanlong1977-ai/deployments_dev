...
variable "idm_recovery_services_vault_resource_group" {
  type        = string
...
variable "idm_storage_account_ntwk_name" {
  type        = string
  description = "Name of the Identity network diagnostics storage account."
}

variable "idm_storage_account_ntwk_resource_group" {
  type        = string
