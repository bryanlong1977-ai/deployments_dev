...
variable "mgmt_storage_account_diag_name" {
  type        = string
  description = "Name of the diagnostics storage account"
}

variable "mgmt_storage_account_diag_resource_group" {
  type        = string
  description = "Resource group name for the diagnostics storage account"
}

variable "mgmt_storage_account_diag_enable_private_endpoint" {
  type        = bool
  description = "Whether to enable private endpoint for the diagnostics storage account"
}

variable "mgmt_storage_account_diag_pe_services" {
  type        = list(string)
  description = "List of storage services to create private endpoints for"
}

variable "snet_pe_mgmt_cus_01_subnet_name" {
  type        = string
  description = "Name of the private endpoint subnet in management VNet"
}
...
# NOTE: var.blob_dns_zone_name is not in shared terraform.tfvars.
