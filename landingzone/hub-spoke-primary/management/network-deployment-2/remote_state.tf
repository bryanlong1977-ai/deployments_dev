# =============================================================================
# Remote State References - Management Network Deployment 2
# =============================================================================

# Connectivity Network Deployment 1 - Network Watcher
...
# Management Network Deployment 1 - VNet, Subnets, Resource Group
...
# Management Tools Deployment 1 - Log Analytics Workspace
...
# Management Tools Deployment 2 - Network Storage Account
data "terraform_remote_state" "management_tools_2" {
  backend = "azurerm"
  config = {
    resource_group_name  = "rg-storage-ncus-01"
    storage_account_name = "sacloudaiconsulting01"
