...
variable "dns_resource_group" {
  type        = string
  description = "The resource group name where DNS resources are hosted."
}

variable "hub_network_watcher_name" {
  type        = string
  description = "The name of the Network Watcher in the hub/connectivity subscription."
}

variable "hub_network_watcher_resource_group" {
  type        = string
