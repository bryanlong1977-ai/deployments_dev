...
variable "management_resource_group_name" {
  type        = string
  description = "The name of the resource group for management network resources."
}
...
variable "management_vnet_address_space" {
  type        = string
  description = "The address space CIDR for the management virtual network."
}
...
variable "management_subnets" {
  ...
  description = "Map of subnet name to subnet configuration for management VNet subnets."
}
