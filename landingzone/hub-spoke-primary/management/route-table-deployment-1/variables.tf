variable "management_subscription_id" {
  type        = string
  description = "The subscription ID for the management subscription where the route table will be deployed."
}
...
variable "management_route_table_resource_group" {
  type        = string
  description = "The name of the resource group for the management route table."
}
