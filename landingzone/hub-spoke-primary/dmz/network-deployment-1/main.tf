...
# Resource Group for DMZ Virtual Network
...
# Resource Group for Network Watcher (dedicated RG as per standards)
...
# Subnet: Ingress Firewall Management
...
# Subnet: Ingress Firewall Untrust
...
# VNet Peering: DMZ to Hub (spoke side)
...
# VNet Peering: Hub to DMZ (hub side - using connectivity provider)
